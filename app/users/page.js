        ...
        <tbody>
            {/* <> */}
            {
              users.map((eachData,index)=>(
                ...
                <div className="block"><strong>Email:</strong> {eachData.email}</div>
                <div className="block"><strong>Take Action:</strong> <button className=' bg-red-600 text-white px-8 py-4 rounded-full hover:bg-red-700 transition duration-100 max-sm:px-3 max-sm:py-1' onClick={() => handleDelete(eachData.id)} 
